...
def translate_text(source_lang="en", target_lang="de", text_to_translate=""):
...
if __name__ == "__main__":
    ...
    print(translate_text("en", "de", bored_api.get_random_activity()["activity"]))

    for key, inner_dict in bored_api.get_random_activities().items():
        activity = inner_dict['activity']
        print(translate_text("en", "de", activity))
